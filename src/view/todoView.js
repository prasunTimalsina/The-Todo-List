...
class TodoView extends View {
  ...
  _generateMarkup() {
    ...
    return `
    <li class="todo  ${this._data.completed ? "completed" : ""}" >
            <div >
              <input type="checkbox"  ${this._data.completed ? "checked" : ""}>
              <p class="todo-title">${this._data.taskTitle}</p>
            </div>
            <div class="todo-due">
